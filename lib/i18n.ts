...
const englishCopy: Record<string, string> = {
  ...
  "请通过 localhost 或 HTTPS 安全连接使用支持加密的现代浏览器。": "Use a modern browser with encryption support via localhost or HTTPS.",
  "无法访问本机存储。": "Local storage is unavailable.",
  "正在加密保存，请稍候再锁定。": "Encryption is in progress. Please wait before locking.",
  "锁定后未保存的工作内容会清除。请先保存需要保留的内容，确定锁定？": "Locking discards unsaved work. Save anything you need first. Lock now?",
  "两次输入的密码不一致。": "Passwords do not match.",
  "设置保险库密码": "Set vault password",
  ...
  "输入密码，解锁本机的存档和机构库。": "Enter your password to unlock local archives and institutions.",
  "密码": "Password",
  "确认密码": "Confirm password",
  "密码不会保存，忘记后无法恢复数据。请使用较长且独有的密码，并妥善保管。": "Your password is not stored. Forgotten passwords cannot be recovered. Use a long, unique password and keep it safe.",
  "正在处理…": "Processing…",
  "设置密码并加密": "Set password and encrypt",
  "解锁": "Unlock",
