...
const englishCopy: Record<string, string> = {
  ...
  "初始化加密保险库": "Initialize encrypted vault",
  "迁移旧保险库": "Migrate old vault",
  ...
  "请输入原来的保险库密码。验证成功后会自动迁移，以后无需再输入。": "Enter the previous vault password once. After verification, the vault will be migrated automatically and will no longer ask for it.",
  "原保险库密码": "Previous vault password",
  "正在处理…": "Processing…",
  "迁移并解锁": "Migrate and unlock",
